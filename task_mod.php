...
<form name="f1" method="post" action="pm_task_mod.php">
   ...
   ?>
		...
		<br  /><br  />
		<input type="number" min="1" name="hours" value="<?php if(isset($_POST['s1'])) { echo $var['Hours']; } ?>" />
		<br  /><br  />
		<input type="number" min="1" name="members" value="<?php if(isset($_POST['s1'])) { echo $var['Members']; } ?>" />
		<br  /><br  />
